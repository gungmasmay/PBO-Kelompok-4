    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (namaPelanggan == null) {
                System.out.println("ID Pelanggan tidak ditemukan. Program berhenti.");
                return;
            }
            ...
            do {
                ...
                switch (pilihan) {
                        ...
                        while (top) {
                            ...
                            for (Barang b : daftarBarang) {
                                if (b.getKode().equalsIgnoreCase(kodeBarang)) {
                                    barangDipilih = b;
                                    Pesanan pesananBaru = new Pesanan(barangDipilih, jumlahPesanan);
                                    break;
                                }
                            }
                            ...
                            if (barangDipilih != null) {
                                ...
                                if (jumlah > 0) {
                                    ...
                                    daftarPesanan.add(new Pesanan(barangDipilih, jumlah));
                    ...
                    case 2:
                        if (totalBelanja > 0) {
                            transaksi.prosesTransaksi(totalBelanja, IDPelanggan, daftarPesanan);
